...
public class CameraPreview extends TextureView {
    ...
    public void setClassifier(PokemonClassifier pokemonClassifier) {
        mPokemonClassifier = pokemonClassifier;
    }
    @Override
...
//當Activity或Fragment OnResume()時,可以沖洗開啟一個相機並開始預覽,否則,這個Surface已經準備就緒
    ...
    private final TextureView.SurfaceTextureListener mSurfaceTextureListener = new TextureView.SurfaceTextureListener() {
        ...
        public void onSurfaceTextureUpdated(SurfaceTexture texture) {
            if (capturingStillPicture) {
                Bitmap frame = getBitmap();
                mPokemonClassifier.classifyImage(frame);

                capturingStillPicture = false;
            }
        }
    };
...
// 在這個例子中不使用前置攝像頭
            ...
            Log.e(TAG, "device doesn't support Camera2");
        }
    }
